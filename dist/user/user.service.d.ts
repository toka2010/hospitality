...
export declare class UserService {
    ...
    constructor(_userModel: Model<User>, _phoneService: PhoneRegistrationService);
    create(body: CreateUserDto): Promise<import("mongoose").Document<unknown, any, User> & User & Required<{
        _id: number;
    }>>;
