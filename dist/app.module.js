...
const filter_exceptions_1 = require("./shared/filter-exceptions");
...
AppModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [
            ...
            { provide: core_1.APP_FILTER, useClass: filter_exceptions_1.AllExceptionsFilter },
            { provide: core_1.APP_PIPE, useClass: default_validation_1.DefaultValidationPipe },
        ],
    })
], AppModule);
